...
const deleteChapterController = async (req, res, next) => {
    try {
        if (!req.user) {
        ...
        const validatedData = chapterSchema_1.deleteChapterSchema.parse(req.body);
        const chapter = await prisma_1.default.chapter.delete({
            where: {
                id: validatedData.id
            },
            select: {
...
exports.default = deleteChapterController;
